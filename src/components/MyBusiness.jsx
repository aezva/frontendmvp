      ...
      <div className="flex flex-col flex-1 min-h-0 h-full w-full">
        ...
        <Card className="bg-card/50 backdrop-blur-sm hover:shadow-sm transition-shadow flex flex-col min-h-0 h-full p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1 min-h-0 h-full w-full">
            <TabsList className="flex items-center gap-6 w-full h-12 min-h-[48px] justify-start px-0" style={{ alignItems: 'center' }}>
              <TabsTrigger value="general" className="text-base font-light pb-2 flex items-center gap-1 data-[state=active]:text-[#ff9c9c] data-[state=inactive]:text-black">
                <Building className="h-5 w-5 inline mr-1" style={{ color: '#ff9c9c' }} strokeWidth={1.5} />General
              </TabsTrigger>
              <TabsTrigger value="contact" className="text-base font-light pb-2 flex items-center gap-1 data-[state=active]:text-[#ff9c9c] data-[state=inactive]:text-black">
                <Phone className="h-5 w-5 inline mr-1" style={{ color: '#ff9c9c' }} strokeWidth={1.5} />Contacto
              </TabsTrigger>
              <TabsTrigger value="services" className="text-base font-light pb-2 flex items-center gap-1 data-[state=active]:text-[#ff9c9c] data-[state=inactive]:text-black">
                <Settings className="h-5 w-5 inline mr-1" style={{ color: '#ff9c9c' }} strokeWidth={1.5} />Servicios
              </TabsTrigger>
              <TabsTrigger value="content" className="text-base font-light pb-2 flex items-center gap-1 data-[state=active]:text-[#ff9c9c] data-[state=inactive]:text-black">
                <FileText className="h-5 w-5 inline mr-1" style={{ color: '#ff9c9c' }} strokeWidth={1.5} />Contenido
              </TabsTrigger>
              <TabsTrigger value="social" className="text-base font-light pb-2 flex items-center gap-1 data-[state=active]:text-[#ff9c9c] data-[state=inactive]:text-black">
