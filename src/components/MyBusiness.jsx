        ...
        <Card className="bg-card/50 backdrop-blur-sm hover:shadow-sm transition-shadow flex flex-col h-full p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col h-full w-full">
            <TabsList className="flex items-center gap-6 w-full h-12 min-h-[48px] justify-start px-0 bg-transparent border-b border-border" style={{ alignItems: 'center', background: 'transparent', padding: 0, boxShadow: 'none', borderBottom: '1px solid #e5e7eb' }}>
              ...
              <TabsTrigger value="contact" className="text-base font-light pb-2 flex items-center gap-1 bg-transparent border-none shadow-none px-0 py-0 m-0 data-[state=active]:text-[#ff9c9c] data-[state=inactive]:text-black" style={{ background: 'transparent', border: 'none', boxShadow: 'none', padding: 0, margin: 0 }}>
                <Phone className="h-5 w-5 inline mr-1" style={{ color: '#ff9c9c' }} strokeWidth={1.5} />Contacto
              </TabsTrigger>
              <TabsTrigger value="services" className="text-base font-light pb-2 flex items-center gap-1 bg-transparent border-none shadow-none px-0 py-0 m-0 data-[state=active]:text-[#ff9c9c] data-[state=inactive]:text-black" style={{ background: 'transparent', border: 'none', boxShadow: 'none', padding: 0, margin: 0 }}>
            ...
            {/* General */}
            <TabsContent value="general" className="flex-1 flex flex-col pt-6">
            ...
            {/* Contacto */}
            <TabsContent value="contact" className="flex-1 flex flex-col pt-6">
              <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
                <div className="grid grid-cols-1 gap-6 mt-0">
                  <div className="space-y-2">
            ...
            {/* Servicios */}
            <TabsContent value="services" className="flex-1 flex flex-col pt-6">
              <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
                <div className="grid grid-cols-1 gap-6 mt-0">
                  <div className="space-y-2">
            ...
            {/* Contenido */}
            <TabsContent value="content" className="flex-1 flex flex-col pt-6">
              <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
                <div className="grid grid-cols-1 gap-6 mt-0">
                  <div className="space-y-2">
            ...
            {/* Social */}
            <TabsContent value="social" className="flex-1 flex flex-col pt-6">
              <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
                <div className="grid grid-cols-1 gap-6 mt-0">
                  <div className="space-y-2">
