    ...
    <header className="sticky top-0 z-50 w-full bg-background border-b border-border grid grid-cols-3 items-center px-6 h-16">
      ...
      <div className="flex items-center gap-4 justify-end min-w-0">
        ...
        <div className="relative" ref={notifRef}>
          ...
          {notifOpen && (
            <div className="absolute right-0 top-[64px] w-80 bg-popover border border-border/50 border-t-0 rounded-lg shadow-xl max-h-96 overflow-y-auto z-50 backdrop-blur-sm">
        ...
        <div className="relative" ref={menuRef}>
          ...
          {menuOpen && (
            <div className="absolute right-0 top-[64px] w-56 bg-popover border border-border/50 border-t-0 rounded-lg shadow-xl z-50 backdrop-blur-sm">
