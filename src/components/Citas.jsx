...
import { Loader2, Pencil, Trash2, CheckCircle2, XCircle, Clock, Calendar, Users } from 'lucide-react';
      ...
      <div className="flex flex-1 gap-6 min-h-0">
        ...
        <div className="w-full md:w-1/3 flex flex-col min-h-0 h-full">
          <section className="flex flex-col flex-1 bg-white/80 border rounded-xl p-6 h-full">
            <h2 className="text-base font-medium text-black mb-4 flex items-center"><Calendar className="mr-3 h-5 w-5" style={{ color: '#ff9c9c' }} strokeWidth={1.5} />Configura tu Disponibilidad</h2>
        ...
        <div className="w-full md:w-2/3 flex flex-col min-h-0 h-full">
          <section className="flex flex-col flex-1 bg-white/80 border rounded-xl p-6 h-full min-h-0">
            <h2 className="text-base font-medium text-black mb-4 flex items-center"><Users className="mr-3 h-5 w-5" style={{ color: '#ff9c9c' }} strokeWidth={1.5} />Citas Agendadas</h2>
