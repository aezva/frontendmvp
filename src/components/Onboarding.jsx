...
const Onboarding = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-start p-4 pb-8 md:pb-4 font-sans" style={{ background: '#F4F4F5' }}>
        {/* Logo NNIA */}
        ...
        <div className="w-full max-w-4xl mx-auto h-auto md:h-[850px] flex flex-col mt-16 md:mt-20">
