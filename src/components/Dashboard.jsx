      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {statsData.map((stat, index) => (
            <Card key={index} className="bg-card/50 backdrop-blur-sm hover:shadow-md transition-colors duration-300 px-6 py-4 flex flex-col justify-center items-start min-h-[180px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-6">
            {/* Tareas Pendientes */}
            <Card className="bg-card/50 backdrop-blur-sm hover:shadow-md transition-shadow px-6 py-4 flex flex-col justify-center items-center min-h-[180px]">
              <div className="flex flex-col items-start gap-3 w-full">
                <div className="flex items-center justify-start w-full gap-2 mb-2">
